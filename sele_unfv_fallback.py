...
start_number = 52000
end_number = 52400  # Cambia este número al final que desees
...
with open('resultados.csv', mode='a', newline='', encoding='utf-8') as csvfile:
    ...
    if csvfile.tell() == 0:
        csv_writer.writerow(['cod_pos', 'nombre', 'esc_prof', 'puntaje', 'condicion'])
    ...
    for number in range(start_number, end_number + 1):
        ...
        cod_pos = driver.find_element(By.XPATH, '/html/body/div/main/div/div[3]/div/div/div[2]/dl/dd[2]').text 
